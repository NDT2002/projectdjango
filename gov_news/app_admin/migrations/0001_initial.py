# Generated by Django 4.2.4 on 2023-09-23 17:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_url', models.URLField(blank=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_email', models.CharField(db_index=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_image', models.ImageField(blank=True, null=True, upload_to=app_admin.models.upload_img)),
                ...
                ('post_guid', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='app_admin.term')),
            ],
            options={
                'db_table': 'terms',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visible', models.CharField(db_index=True, default='Y', max_length=20)),
        ...
        migrations.AddField(
            model_name='comment',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='app_admin.post'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_admin.post')),
                ('term', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_admin.term')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_admin.post')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_admin.tag')),
            ],
            options={
